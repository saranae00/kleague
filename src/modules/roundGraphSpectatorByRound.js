...
const LOAD = 'roundGraphSpectatorByRound/LOAD';
const MOVE = 'roundGraphSpectatorByRound/MOVE';
...
const roundGraphSpectatorByRound = handleActions(
  {
    [LOAD]: (state, action) => {
...
export default roundGraphSpectatorByRound;
